// Chameleon is a string to/from double conversion class written by Rene Nyffenegger.
// It is available at the website http://www.adp-gmbh.ch/cpp/chameleon.html.
//
